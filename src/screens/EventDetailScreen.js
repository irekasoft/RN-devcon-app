           ...
           <View style={styles.cell}>
             <View style={{flexDirection:'row'}}>
               ...
               <View style={{flex: 3,paddingHorizontal:12,paddingVertical:0,}}>
                 ...
                 <Text style={{fontSize:11, color:'gray'}}>{this.props.navigation.state.params.item.date_string}</Text>
                 <Text style={{fontSize:11, color:'gray'}}>{this.props.navigation.state.params.item.time_start_end}</Text>
               </View>
             </View>
           </View>
           <View style={styles.cell}>
